...
module Krikri
  ...
  class PluginManager
    ...
    # Written once at the end of a run (krikri-playbook.cr), not on every
    ...
    # moment krikri-playbook lives under a directory that become_user
    ...
    # directories exist." task (become_user: solr, krikri-playbook
    # installed under /root/krikri-playbook-bin): `sudo: Sorry, user
