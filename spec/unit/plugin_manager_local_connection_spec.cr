...
describe CrystalPlay::PluginManager do
  describe ".is_local_connection?" do
    it "treats a host named 127.0.0.1 the same as localhost" do
      ...
      CrystalPlay::PluginManager.is_local_connection?(host, host.vars).should be_true
    end
    ...
    it "does not treat an ordinary remote host as local" do
      ...
      CrystalPlay::PluginManager.is_local_connection?(host, host.vars).should be_false
    end
