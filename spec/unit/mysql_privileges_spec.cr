...
describe Krikri::PluginHelpers::MysqlPrivileges do
  ...
  describe ".parse_show_grants_line" do
    it "returns nil for the baseline GRANT USAGE identity row" do
      ...
      Krikri::PluginHelpers::MysqlPrivileges.parse_show_grants_line(line).should be_nil
    end
    ...
    it "strips backticks from the target" do
      ...
      (Krikri::PluginHelpers::MysqlPrivileges.parse_show_grants_line(line) || raise "unexpected nil").target.should eq("testdb2.*")
    end

    it "returns nil for a non-GRANT line" do
      Krikri::PluginHelpers::MysqlPrivileges.parse_show_grants_line("Grants for demo1@%").should be_nil
    end
  end
